...
[SVG 작성 규칙]
- viewBox="0 0 80 80" 기준 (80×80 정사각형)
- 배경 없음 (투명)
- 산업용 HMI 스타일: 단순하고 명확한 선, 두께 2px
- 색상: 외곽선 #00d4ff (밝은 청록), 내부 채움 #0a2040 (어두운 파랑)
- 텍스트/라벨 SVG 안에 절대 포함 금지
- 모든 요소는 stroke="#00d4ff" stroke-width="2" fill="#0a2040"
...
<svg viewBox="0 0 80 80" xmlns="http://www.w3.org/2000/svg">
  <rect x="5" y="55" width="70" height="8" rx="2" fill="#0a2040" stroke="#00d4ff" stroke-width="1.5"/>
  <line x1="20" y1="55" x2="15" y2="35" stroke="#00d4ff" stroke-width="2"/>
  <line x1="25" y1="55" x2="20" y2="35" stroke="#00d4ff" stroke-width="1.5"/>
  <line x1="60" y1="55" x2="65" y2="35" stroke="#00d4ff" stroke-width="2"/>
  <line x1="55" y1="55" x2="60" y2="35" stroke="#00d4ff" stroke-width="1.5"/>
  <g id="rotate-unwinder">
    <circle cx="40" cy="32" r="22" fill="#071830" stroke="#00d4ff" stroke-width="2"/>
    <circle cx="40" cy="32" r="10" fill="#0a2040" stroke="#00d4ff" stroke-width="1.5"/>
    <circle cx="40" cy="32" r="3" fill="#00d4ff"/>
    <line x1="40" y1="10" x2="40" y2="54" stroke="#1e3a5f" stroke-width="1" stroke-dasharray="3 3"/>
    <line x1="18" y1="32" x2="62" y2="32" stroke="#1e3a5f" stroke-width="1" stroke-dasharray="3 3"/>
  </g>
</svg>

펌프:
<svg viewBox="0 0 80 80" xmlns="http://www.w3.org/2000/svg">
  <rect x="8" y="42" width="20" height="20" rx="2" fill="#0a2040" stroke="#00d4ff" stroke-width="1.5"/>
  <g id="rotate-pump">
    <circle cx="42" cy="36" r="22" fill="#071830" stroke="#00d4ff" stroke-width="2"/>
    <path d="M42 14 L56 36 L42 36 Z" fill="#00d4ff" opacity="0.6"/>
    <circle cx="42" cy="36" r="5" fill="#00d4ff"/>
  </g>
  <rect x="12" y="33" width="8" height="6" fill="#0a2040" stroke="#00d4ff" stroke-width="1.5"/>
  <rect x="64" y="33" width="8" height="6" fill="#0a2040" stroke="#00d4ff" stroke-width="1.5"/>
</svg>

탱크:
<svg viewBox="0 0 80 80" xmlns="http://www.w3.org/2000/svg">
  <rect x="20" y="12" width="40" height="55" rx="3" fill="#0a2040" stroke="#00d4ff" stroke-width="2"/>
  <ellipse cx="40" cy="12" rx="20" ry="5" fill="#071830" stroke="#00d4ff" stroke-width="2"/>
  <g id="fill-level">
    <rect x="21" y="42" width="38" height="24" fill="#0d3060" opacity="0.8"/>
  </g>
  <line x1="36" y1="5" x2="36" y2="12" stroke="#00d4ff" stroke-width="2"/>
  <line x1="40" y1="67" x2="40" y2="75" stroke="#00d4ff" stroke-width="2"/>
</svg>

모터/팬:
<svg viewBox="0 0 80 80" xmlns="http://www.w3.org/2000/svg">
  <rect x="8" y="26" width="34" height="28" rx="3" fill="#0a2040" stroke="#00d4ff" stroke-width="2"/>
  <g id="rotate-fan">
    <circle cx="58" cy="40" r="16" fill="#071830" stroke="#00d4ff" stroke-width="2"/>
    <path d="M58 24 Q68 32 68 40 Q68 48 58 56 Q48 48 48 40 Q48 32 58 24Z" fill="#00d4ff" opacity="0.4"/>
    <circle cx="58" cy="40" r="4" fill="#00d4ff"/>
  </g>
  <line x1="42" y1="40" x2="48" y2="40" stroke="#00d4ff" stroke-width="2"/>
</svg>

[사용자 요청 장비명 → SVG 스타일 선택]
  언와인더/와인더/롤 → 롤 스타일 (rotate-unwinder)
  펌프/pump → 펌프 스타일 (rotate-pump)
  탱크/조/tank → 탱크 스타일 (fill-level)
  모터/팬/블로어 → 모터 스타일 (rotate-fan)
  밸브/valve → 마름모 형태 밸브 (toggle-valve)
  컨베이어 → 벨트 + 롤러 선
  그 외 → 장비 특성에 맞게 창의적으로 생성
